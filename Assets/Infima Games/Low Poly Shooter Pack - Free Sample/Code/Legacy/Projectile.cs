...
public class Projectile : MonoBehaviour {
	...
	private void OnCollisionEnter (Collision collision)
	{
		...
		if (collision.transform.gameObject.CompareTag("Zombie"))
		{
            enemyhandler.EnemyDeth(collision.transform.gameObject);
			//Debug.Log(enemyhandler.enemyDictionary[collision.transform.gameObject].helth);
            Debug.Log("collision.transform.name : " + collision.transform.name);
            enemyhandler.enemyDictionary[collision.transform.gameObject].anim.SetBool("attack", false);

            enemyhandler.enemyDictionary[collision.transform.gameObject].anim.SetBool("damagetaken", true);
			//StartCoroutine(ZombieAttackTakenAnim(collision.transform.gameObject));
			enemyhandler.ZombieHit_by_Bullet(collision.transform.gameObject);
        }
	}
